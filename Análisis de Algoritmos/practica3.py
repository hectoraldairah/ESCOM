...
import ww.algoritmos.modulo_tres as pbdyv
...
parseador = argumentos.ArgumentParser(description='Práctica 3: Multiplicación de números binarios mediante DyV por wwww', epilog='Ejemplo: ./practica3.py -n1 1001 -n2 1010 -m 4')
