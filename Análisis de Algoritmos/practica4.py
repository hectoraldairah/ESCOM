...
import ww.algoritmos.modulo_cuatro as mmdyv

parseador = argumentos.ArgumentParser(description='Práctica 4: Multiplicación de matrices mediante DyV por wwww', epilog='Ejemplo: ./practica4.py -a archivo1 -b archivo2 -m clasico')
