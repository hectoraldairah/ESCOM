...
from ww.algoritmos.modulo_cinco import init as iniciarAlgoritmo
'''

def crearColsPesos(pesoMochila):
	p = 0
	q = []
	for i in range(0, pesoMochila+1):
		q.append(i)
	return q
def crearMatriz(filas, columnas):
	...
	for i in range(0, filas):
		...
		for j in range(0, columnas):
			renglon.append([[-1, -1], 0, "#"]) # Coordenadas apuntadoras, precio inicial, flag [S]i/[N]o
		tabla.append(renglon)
	return tabla

# TODO: Validar que el peso de cada producto no supere el tamaño de la mochila

tamanioMochila = 3
productos = [(), (67000, 100), (10024, 150), (45000, 80)]
#productos = [(), (35600, 100), (15315, 400), (156000, 50), (30000, 20), (10000, 300)] # Precio, peso
colsPesos = crearColsPesos(tamanioMochila)
print colsPesos
print crearMatriz(len(productos), len(colsPesos))
...
parseador = argumentos.ArgumentParser(description='Práctica 5: Producto secuencia de matrices por wwww', epilog='Ejemplo: ./practica5.py -n nombre1,nombre2,nombre3 -t 2x4,4x3,3x5 -v')
...
'''
print "Por ww ww - ww.com/algoritmos"
exit()