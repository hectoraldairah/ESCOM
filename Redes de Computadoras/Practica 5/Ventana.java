...
public class Ventana extends JFrame
{
	...
	{
		this.setLyF();
		this.setTitle("Analizador de tramas Ethernet - ww.com");
			...
			new ActionListener()
			{
				public void actionPerformed(ActionEvent z)
				{
					if(nic.isSelected())
					{
						...
						JOptionPane.showMessageDialog(null, "Por ww ww - 2CM9\n\nwww.ww.com", "Creditos", JOptionPane.WARNING_MESSAGE);
						System.exit(0);
					}
					else if(pcap.isSelected())
					{
						...
						selector.setDialogTitle("Abrir archivo PCAP - ww.com");
