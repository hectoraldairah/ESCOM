    ...
    public void corePcap(int cant, String ficheroTramas)
    {
        ...
        try
        {
			...
			try
            {
	        	...
	        	Paragraph autor = new Paragraph("ww ww ww - 2CM9", FontFactory.getFont("Impact", 12, Font.ITALIC, BaseColor.DARK_GRAY));
	        	autor.setAlignment(Element.ALIGN_CENTER);
	        	Anchor ma = new Anchor("www.ww.com/jnetpcap", FontFactory.getFont("Impact", 9, Font.UNDERLINE, BaseColor.GRAY));
	        	ma.setReference("http://www.ww.com/");
