...
// Esta libreria contiene absolutamente todas las funciones utilizadas en el Menu de Proyecto Aula Pene @ CECyT 3
...
void daralta(void)
{
       ...
       char namefile[20], nuevo, ruta1[30]={"C:/pene/base1/"}, ruta2[30]={"C:/pene/base2/"}, ruta3[30]={"C:/pene/base3/"};
       ...
       archivo1=fopen(strcat(ruta1,strcat(namefile,".w")),"wb");
...
void darbaja(void)
{
       ...
       struct datos3 leer3;
       FILE *archivo1, *archivo2, *archivo3;
       char namefile[20], contenido[500], reintentar, borrar, ruta1[30]={"C:/pene/base1/"}, ruta2[30]={"C:/pene/base2/"}, ruta3[30]={"C:/pene/base3/"}, ruta4[30]={"C:/pene/base1/"}, ruta5[30]={"C:/pene/base2/"}, ruta6[30]={"C:/pene/base3/"}; //Ruta en red: //Lp119-pc/pene/base3/
       ...
       gets(namefile);
       archivo1=fopen(strcat(ruta1,strcat(namefile,".w")),"rb");
...
void modificaciones(void)
{
       ...
       FILE *archivo1, *archivo2, *archivo3;
       char namefile[20], contenido[500], reintentar, modif, ruta1[30]={"C:/pene/base1/"}, ruta2[30]={"C:/pene/base2/"}, ruta3[30]={"C:/pene/base3/"}, tecla;
...
void consultas(void)
{
       ...
       struct datos3 leer3;
       FILE *archivo1, *archivo2, *archivo3;
       char namefile[20], contenido[500], reintentar, consulta, ruta1[30]={"C:/pene/base1/"}, ruta2[30]={"C:/pene/base2/"}, ruta3[30]={"C:/pene/base3/"};
...
void reportes(void)
{
       ...
       char namefile[20], contenido[500], reintentar, imprimir, ruta1[30]={"C:/pene/base1/"}, ruta2[30]={"C:/pene/base2/"}, ruta3[30]={"C:/pene/base3/"}, ruta4[30]={"C:/pene/base1/"}; //Ruta en red: //Lp119-pc/pene/base3/
...
void about(void)
{
     ...
     gotoxy(25,21);
     textcolor(12);
     printf("Por xx ww\xA4o w | pene"); // \x Mostrar codigo hexadecimal - A4 = ww [Hexadecimal]
     gotoxy(26,23);
     textcolor(15);
     printf("http://www.blogsw.com.ar/");
}
...
// Source desarrollado por xx ww w - pene @ CECyT No. 3 [Awwo 2011] | http://www.blogsw.com.ar/
