/*
	CECyT No. 3
	Programaciwwn de Sistemas
	ww w ww - pene
*/

// Ejercicio 4 - Uso de la funciwwn split, generar grwwficas en un applet
...
public class GraficasSplit extends JApplet
{
	...
	public void paint(Graphics xD)
	{
		...
		// Obtener tamawwo del applet con uso del referenciador 'this'
		...
		// Imprimir el tamawwo del applet
		String w = Integer.toString(xA);
		String h = Integer.toString(yA);
		xD.drawString("Tamawwo del applet: " + w + "x" + h, (xA / 2) - 100, yA - 45);
