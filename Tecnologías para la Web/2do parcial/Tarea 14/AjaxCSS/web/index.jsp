...
<html>
    ...
    <body>
        <script type="text/javascript">
            ...
            {
                cache++;
                document.getElementById("resultado").innerHTML = "<style type='text/css'>@import url('http://localhost:8080/AjaxCSS/ww/estilos.css?actualizado="+cache+"')</style>"+document.getElementById("cHTML").value;
            }
