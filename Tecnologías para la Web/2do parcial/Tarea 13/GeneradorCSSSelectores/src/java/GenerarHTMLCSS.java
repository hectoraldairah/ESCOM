...
/*
    SOLUCION:
    - Leer archivo: chmod 777 ww (directorio en .../build/web/)
    - Escribir en archivo: chmod 666 nombres.xml (archivo en .../build/web/ww/nombres.xml)
*/
...
public class GenerarHTMLCSS extends HttpServlet
{
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        String css = sesion.getServletContext().getRealPath("/ww/estilos.css");
        PrintWriter p = response.getWriter();
        FileWriter estilo = new FileWriter(css);
        
        p.println("<html><head><link rel='stylesheet' type='text/css' href='/GeneradorCSSSelectores/ww/estilos.css'/></head><body>");
        ...
        try
        {
            ...
            p.println("<span id='seleccionwwDotCom'>Selecciona este texto...</span><br/>");
            estilo.write("#seleccionwwDotCom::selection {"+request.getParameter("cssSeleccion")+"}\n");
            estilo.write("#seleccionwwDotCom::-moz-selection {"+request.getParameter("cssSeleccion")+"}\n");
        }
        catch(IOException x)
        {
