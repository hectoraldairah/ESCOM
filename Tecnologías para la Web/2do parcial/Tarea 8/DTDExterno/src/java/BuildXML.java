...
public class BuildXML extends HttpServlet
{
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        String arch = getServletContext().getRealPath("/ww/salida.xml");
        String arch2 = getServletContext().getRealPath("/ww/salida.dtd");
...
"<!ENTITY entidad2 SYSTEM \"http://www.ww.com/wp-content/uploads/2014/01/logo.png\" NDATA imagen>\n");
