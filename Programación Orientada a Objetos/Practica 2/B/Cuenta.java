/*
 * Descripcion: esta clase estww relacionada con el manejo de cuentas bancarias
 * @author: ww ww w - 2CV7
 */
public class Cuenta
{
	...
	/*
	 * Constructor por parwwmetros: cwwrculo
	 * @param: num identificador
	 * @param: key NIP
	 * @param: sald saldo inicial
	 * @param: ia interwws anual
		...
		if(cnt > 0)
		{
			if(cnt < saldo)
			{
				if(cnt % 50 == 0.0 || cnt % 100 == 0.0 || cnt % 200 == 0.0 || cnt % 500 == 0.0)
				{
					...
					return false; // La cantidad no es un mwwltiplo de 50, 100, 200, 500
			}
			else
